...
const topCategories = [
	...
	},
	{
		...
		description:
			'Personal and professional development courses are designed to maximise your career potential by enhancing and expanding your skillset.',
	...
	},
	{
		...
		description:
			' Design courses can introduce students to fundamentals of design as they are applied to different segments of the industry. ',
	},
	{
		...
		name: 'Grow your Design skills',
		description:
			'Business courses combines elements of accountancy, finance, marketing, organizational studies, human resource management, and operations.',
	},
	{
		...
		description:
			'Discover how by studying for industry-approved computing qualifications and developing the necessary skills, an IT course can really empower your technology skills',
	},
	{
		...
		description:
			'Photography & Video courses enable the candidates to understand the utility of different camera parts, working out the lights while clicking pictures and the art of taking candid shots.',
	},
]
const Home = () => {
		...
		<>
			...
			<div className="px-[7%]">
				<div className="ml-2 mt-5 px-5">
					<p className="text-3xl font-serif">A broad selection of courses</p>
				...
				<div className="bg-white py-2">
					<div className="relative bg-gray-900">
						...
						<div className="relative max-w-3xl mx-auto py-32 px-6 flex flex-col items-center text-center sm:py-64 lg:px-0">
							...
							<p className="mt-4 text-xl text-white">View the courses that you are already enrolled in</p>
							<button
								type="button"
			...
			<div className="px-[7%]">
				<div className="ml-2 my-3 px-5">
					<p className="text-3xl font-serif">Top Categories</p>
