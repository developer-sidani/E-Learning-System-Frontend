...
const CoursesSlider = ({ loading, courses }) => {
  ...
  return (
    <CarouselProvider infinite id="carouselExampleSlidesOnly" className="carousel slide relative" data-bs-ride="carousel" naturalSlideWidth={300} isIntrinsicHeight totalSlides={loading ? 10 : courses.length} visibleSlides={getSettingsForCarousel.visibleSlides} step={getSettingsForCarousel.step}>
      <ButtonBack
